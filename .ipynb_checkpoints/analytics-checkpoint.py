...
TRI_BENCHMARKS = {
    "Nifty 50 TRI": "120716",       # UTI Nifty 50 Index Fund - Direct Growth
    "Nifty 100 TRI": "147518",      # (already had this - keep as-is)
    "Nifty 500 TRI": "147623",      # Motilal Oswal Nifty 500 Index Fund - Direct Growth
    "Nifty Midcap 150 TRI": "147622",   # Motilal Oswal Nifty Midcap 150 Index Fund - Direct Growth
    "Nifty Smallcap 250 TRI": "147620", # Motilal Oswal Nifty Smallcap 250 Index Fund - Direct Growth
}
...
def get_tri(index_ticker):
    nifty = yf.Ticker(index_ticker)
    data = nifty.history(period="17y")
...
def category_risk_metrics_monthly(
    ...
    metrics = []
    codes = []
    print("debug",category_amfi_codes)
